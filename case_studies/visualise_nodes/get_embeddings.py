...
os.makedirs("case_studies/umaps/data_finetuned", exist_ok=True)
with open("case_studies/umaps/data_finetuned/block_embeddings.npy", "wb") as f:
    np.save(f, block_embeddings)
with open("case_studies/umaps/data_finetuned/block_id.npy", "wb") as f:
    np.save(f, block_id)
with open("case_studies/umaps/data_finetuned/atom_embeddings.npy", "wb") as f:
    np.save(f, atom_embeddings)
with open("case_studies/umaps/data_finetuned/atom_id.npy", "wb") as f:
    np.save(f, atom_id)
with open("case_studies/umaps/data_finetuned/graph_embeddings.npy", "wb") as f:
