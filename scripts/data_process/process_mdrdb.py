...
def process_one_complex(complex_file_name, mut_site, smiles, interface_dist_th, fragmentation_method):
    ...
    try:
        ...
        try:
            blocks2 = atom_blocks_to_frag_blocks(blocks2, smiles, fragmentation_method=fragmentation_method)
        except Exception as e:
            # continue with atom level blocks
...
def process_wt_mt_pair(dirname, mut_site, smiles, ddG, interface_dist_th, fragmentation_method):
    item = {}
